...
$rootPath = __DIR__."/src/goo1-elementor-widgets/";

$str = file_get_contents(__DIR__."/src/goo1-elementor-widgets/goo1-elementor-widgets.php");
...
file_put_contents(__DIR__."/src/goo1-elementor-widgets/goo1-elementor-widgets.php", $str);
echo("Version: ".$m2["v"]." => ".$m["v"].PHP_EOL);

// Initialize archive object
$zip = new ZipArchive();
$zip->open('dist/goo1-elementor-widgets.zip', ZipArchive::CREATE | ZipArchive::OVERWRITE);
